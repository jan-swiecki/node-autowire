...
Injector.prototype.wrap = function(callback, safe) {
  ...
  //newCallback.isAutoDiscoverModules = false;
  newCallback.applyInject = function(keyToValue) {
    var isAutoDiscoverModules = false;

    console.log("isAutoDiscoverModules ->", isAutoDiscoverModules);
    ...
    _(parsedParamNames).forEach(function(parsedParamName) {
      ...
      if(typeof wiredValue === 'undefined' && isAutoDiscoverModules === true) {
        ...
        self.moduleFinder.discoverModuleByName(parsedParamName).then(function(lib){
          wiredValue = lib;
        });
      }
    ...
    return newCallback.apply(undefined, arrayArgs);
  };
  ...
  newCallback.autoWireModules = function() {
    ...
    _newCallback.applyInject =
        self.codeMutator.newVariableDeclarationValue(newCallback.applyInject, "isAutoDiscoverModules", true);
