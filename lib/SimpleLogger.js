...
SimpleLogger.prototype.getLevelFromEnv = function() {
  ...
  // modulefinder=trace;injector=debug
  ...
  if(levels) {
    var level = _(levels.split(";"))
      ...
      .first();
      //console.log("======>", levels, self.loggerName, level);
    if(level) {
...
SimpleLogger.getLogger = function(name, prefix, clazz) {
...
SimpleLogger.resolvePrefix = function(parentModule) {
